...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-wordpress-rest-api/node_modules/wordpress-rest-api/wp.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    <h1 style="font-weight: bold;">
        <a href="https://github.com/npmtest/node-npmtest-wordpress-rest-api">npmtest-wordpress-rest-api (v0.0.1)</a>
    </h1>
    <h1>Code coverage report for <span class="entity">node-npmtest-wordpress-rest-api/node_modules/wordpress-rest-api/wp.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-wordpress-rest-api/node_modules/wordpress-rest-api/</a> &#187; wp.js</div>
</div>
<div class="body">
 ...
 */
<span class="fstat-no" title="function not covered" >function WP( options ) {</span>
&nbsp;
	// Enforce `new`
<span class="cstat-no" title="statement not covered" >	if ( this instanceof WP === false ) {</span>
<span class="cstat-no" title="statement not covered" >		return new WP( options );</span>
	}
&nbsp;
	// Dictionary to be filled by handlers for default namespaces
<span class="cstat-no" title="statement not covered" >	this._ns = {};</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >	this._options = extend( {}, defaults, options );</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >	if ( ! this._options.endpoint ) {</span>
<span class="cstat-no" title="statement not covered" >		throw new Error( 'options hash must contain an API endpoint URL string' );</span>
	}
&nbsp;
	// Ensure trailing slash on endpoint URI
<span class="cstat-no" title="statement not covered" >	this._options.endpoint = this._options.endpoint.replace( /\/?$/, '/' );</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >	return this.bootstrap( options &amp;&amp; options.routes );</span>
}
&nbsp;
/**
 ...
 */
WP.site = <span class="fstat-no" title="function not covered" >function( endpoint, routes ) {</span>
<span class="cstat-no" title="statement not covered" >	return new WP({</span>
		endpoint: endpoint,
		routes: routes
	});
};
 ...
 */
WP.prototype.url = <span class="fstat-no" title="function not covered" >function( url ) {</span>
<span class="cstat-no" title="statement not covered" >	var options = extend( {}, this._options, {</span>
		endpoint: url
	});
<span class="cstat-no" title="statement not covered" >	return new WPRequest( options );</span>
};
&nbsp;
/**
 ...
 */
WP.prototype.root = <span class="fstat-no" title="function not covered" >function( relativePath ) {</span>
<span class="cstat-no" title="statement not covered" >	relativePath = relativePath || '';</span>
<span class="cstat-no" title="statement not covered" >	var options = extend( {}, this._options );</span>
	// Request should be
<span class="cstat-no" title="statement not covered" >	var request = new WPRequest( options );</span>
&nbsp;
	// Set the path template to the string passed in
<span class="cstat-no" title="statement not covered" >	request._path = { '0': relativePath };</span>
&nbsp;
 ...
 */
WP.prototype.bootstrap = <span class="fstat-no" title="function not covered" >function( routes ) {</span>
<span class="cstat-no" title="statement not covered" >	var routesByNamespace;</span>
<span class="cstat-no" title="statement not covered" >	var endpointFactoriesByNamespace;</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >		if ( ! defaultEndpointFactories ) {</span>
<span class="cstat-no" title="statement not covered" >			routesByNamespace = buildRouteTree( defaultRoutes );</span>
<span class="cstat-no" title="statement not covered" >			defaultEndpointFactories = generateEndpointFactories( routesByNamespace );</span>
		}
<span class="cstat-no" title="statement not covered" >		endpointFactoriesByNamespace = defaultEndpointFactories;</span>
	} else {
<span class="cstat-no" title="statement not covered" >		routesByNamespace = buildRouteTree( routes );</span>
<span class="cstat-no" title="statement not covered" >		endpointFactoriesByNamespace = generateEndpointFactories( routesByNamespace );</span>
	}
&nbsp;
...
<span class="cstat-no" title="statement not covered" >	return Object.keys( endpointFactoriesByNamespace ).reduce(<span class="fstat-no" title="function not covered" >function( wpInstance, namespace ) {</span></span>
<span class="cstat-no" title="statement not covered" >		var endpointFactories = endpointFactoriesByNamespace[ namespace ];</span>
&nbsp;
		// Set (or augment) the route handler factories for this namespace.
<span class="cstat-no" title="statement not covered" >		wpInstance._ns[ namespace ] = Object.keys( endpointFactories ).reduce(<span class="fstat-no" title="function not covered" >function( nsHandlers, methodName ) {</span></span>
<span class="cstat-no" title="statement not covered" >			nsHandlers[ methodName ] = endpointFactories[ methodName ];</span>
<span class="cstat-no" title="statement not covered" >			return nsHandlers;</span>
...
<span class="cstat-no" title="statement not covered" >		if ( namespace === apiDefaultNamespace ) {</span>
<span class="cstat-no" title="statement not covered" >			Object.keys( wpInstance._ns[ namespace ] ).forEach(<span class="fstat-no" title="function not covered" >function( methodName ) {</span></span>
<span class="cstat-no" title="statement not covered" >				wpInstance[ methodName ] = wpInstance._ns[ namespace ][ methodName ];</span>
			});
		}
&nbsp;
<span class="cstat-no" title="statement not covered" >		return wpInstance;</span>
	}, this );
};
&nbsp;
/**
 ...
 */
WP.prototype.namespace = <span class="fstat-no" title="function not covered" >function( namespace ) {</span>
<span class="cstat-no" title="statement not covered" >	if ( ! this._ns[ namespace ] ) {</span>
<span class="cstat-no" title="statement not covered" >		throw new Error( 'Error: namespace ' + namespace + ' is not recognized' );</span>
	}
<span class="cstat-no" title="statement not covered" >	return this._ns[ namespace ];</span>
};
&nbsp;
/**
 ...
 */
WP.discover = <span class="fstat-no" title="function not covered" >function( url ) {</span>
	// local placeholder for API root URL
<span class="cstat-no" title="statement not covered" >	var endpoint;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >	return autodiscovery.getAPIRootFromURL( url )</span>
		.then( autodiscovery.locateAPIRootHeader )
		.then(<span class="fstat-no" title="function not covered" >function( apiRootURL ) {</span>
			// Set the function-scope variable that will be used to instantiate
			// the bound WP instance, then pass the URL on
<span class="cstat-no" title="statement not covered" >			endpoint = apiRootURL;</span>
<span class="cstat-no" title="statement not covered" >			return apiRootURL;</span>
		})
		.then( autodiscovery.getRootResponseJSON )
		.then(<span class="fstat-no" title="function not covered" >function( apiRootJSON ) {</span>
...
<span class="cstat-no" title="statement not covered" >			console.error( 'Autodiscovery failed' );</span>
...
<span class="cstat-no" title="statement not covered" >				console.warn( 'Endpoint detected, proceeding despite error...' );</span>
<span class="cstat-no" title="statement not covered" >				console.warn( 'Binding to ' + endpoint + ' and assuming default routes' );</span>
<span class="cstat-no" title="statement not covered" >				return new WP.site( endpoint );</span>
			}
...
<div class="footer">
    <div class="meta">Generated by <a href="https://github.com/kaizhu256/node-utility2" target="_blank">utility2</a> at Wed Apr 19 2017 05:16:31 GMT+0000 (UTC)</div>
</div>
</body>
</html>
