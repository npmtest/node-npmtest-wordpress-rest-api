...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-wordpress-rest-api/node_modules/wordpress-rest-api/lib/data/generate-endpoint-response-json.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-wordpress-rest-api/node_modules/wordpress-rest-api/lib/data/generate-endpoint-response-json.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-wordpress-rest-api/node_modules/wordpress-rest-api/lib/data/</a> &#187; generate-endpoint-response-json.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >				console.error( 'Could not save endpoint-response.json' );</span>
<span class="cstat-no" title="statement not covered" >				return process.exit( 1 );</span>
			}
&nbsp;
...
<span class="cstat-no" title="statement not covered" >		var slimJSON = simplifyObject( endpointJSON );</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >		var outputFilePath = path.join( outputPath, 'endpoint-response.json' );</span>
