...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-wordpress-rest-api/node_modules/wordpress-rest-api/lib/route-tree.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-wordpress-rest-api/node_modules/wordpress-rest-api/lib/route-tree.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-wordpress-rest-api/node_modules/wordpress-rest-api/lib/</a> &#187; route-tree.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >	var levelKey = namedGroup ? groupPattern : component || groupName;</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >	currentLevel.component = component;</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >		currentLevel.methods = routeObj.methods ? routeObj.methods.map(<span class="fstat-no" title="function not covered" >function( str ) {</span></span>
...
<span class="cstat-no" title="statement not covered" >							topLevel._getArgs[ argKey ] = endpoint.args[ argKey ].required;</span>
						});
					}
				});
			});
 ...
 */
<span class="fstat-no" title="function not covered" >function reduceRouteTree( routes, namespaces, route ) {</span>
<span class="cstat-no" title="statement not covered" >	var routeObj = routes[ route ];</span>
...
<span class="cstat-no" title="statement not covered" >	return Object.keys( routes ).reduce( reduceRouteTree.bind( null, routes ), {} );</span>
}
&nbsp;
module.exports = {
